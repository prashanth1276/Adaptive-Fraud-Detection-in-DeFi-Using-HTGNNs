...
# Merge into node_df (which is currently not indexed by node)
# node_df is a regular DataFrame with 'node' column; set index temporarily for merging
...
# Fill missing values (nodes with no incoming/outgoing edges)
